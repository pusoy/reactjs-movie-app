        ...
        <ul>
          ...
          <li>
            <Link
              to="/movies"
              className={
                tabMenu === "upcoming" ? "tab-link active" : "tab-link"
              }
              onClick={() => {
                setTabMenu("upcoming");
              }}
          ...
          <li>
            <Link
              to="/movies"
              className={
                tabMenu === "top_rated" ? "tab-link active" : "tab-link"
              }
              onClick={() => {
                setTabMenu("top_rated");
              }}
            >
              Top Rated
            </Link>
          ...
          <li>
            <Link
              to="/movies"
              className={tabMenu === "genre" ? "tab-link active" : "tab-link"}
              onClick={() => {
                setTabMenu("genre");
              }}
            >
